...
var TodocompletedOr = function TodocompletedOr() {
...
var EleNum = function EleNum(page) {
  var numOfEl = localStorage.length - 1;
  var myElementNum = 0;

  for (var i = 0; i < numOfEl; i += 1) {
    var items = JSON.parse(localStorage.getItem(i.toString()));
